                                          ...
                                          <tr>
                                             <td width="30" height="30" align="right">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="https://litmus-builder.s3.amazonaws.com/1426191824733" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             ...
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="https://litmus-builder.s3.amazonaws.com/1426191824430" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             <td align="left" width="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="https://litmus-builder.s3.amazonaws.com/1426191822362" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
         ...
         <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table width="512" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                           <tbody>
                              <tr>
                                 <!-- start of image -->
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="#"><img width="512" border="0" height="512" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="https://legendofporo.files.wordpress.com/2015/05/teemo-poro-icon.png" class="banner"></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                To reset your password, you will need to go to the URL below in your web browser.
                                             </td>
                                          </tr>
                                          <!-- End of content -->
                                          <tr>
                                             ...
                                             <td>
                                                ...
                                                <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                   <tbody>
                                                      <!-- image -->
                                                      <tr>
                                                         <td width="290" height="290" align="center" class="devicewidth">
                                                            <img src="http://orig10.deviantart.net/6850/f/2015/045/e/0/caitlyn_poro_icon_league_of_legends_by_rikkutenjouss-d8i0kkv.png" alt="" border="0" width="290" height="290" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                         </td>
                                                      </tr>
                                                      <!-- Content -->
                                                      <tr>
                                                               ...
                                                               <tbody>
                                                                  ...
                                                                  <tr>
                                                                     <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; line-height:24px; color: #666666; text-align:center;" st-conteent="2colcontent1">
                                                                        You can edit your profile in League Famous
                                                                     </td>
                                                                  </tr>
                                                                  <tr>
                                                                     <td width="100%" height="20"></td>
                                             ...
                                             <td>
                                                ...
                                                <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td width="290" height="290" align="center" class="devicewidth">
                                                            <img src="http://orig03.deviantart.net/4993/f/2015/055/d/9/jinx_poro_icon_league_of_legends_by_rikkutenjouss-d8jbtrr.png" alt="" border="0" width="290" height="290" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                         </td>
                                                      </tr>
                                                      <!-- Content -->
                                                      <tr>
                                 ...
                                 <td>
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                Texto cuquita pa las nenas papu
                                             </td>
                                          </tr>
                                          <!-- End of content -->
                                       </tbody>
